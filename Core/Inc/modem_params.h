...
// RF frequency is 433.00 MHz
// Mod type: 2GFSK,	DataRate: 50.00 ksps;  FreqDev: 25.00 kHz;  RX BW: 100.00 kHz 

// all for TX in this section:
// DataRate: 3 API bytes;  NCOMODulus: 4 bytes; FreqDev: 3 bytes, for TX 
#define MODEM_DATA_RATE_2_14 0x11, 0x20, 0x0A, 0x03,   0x01, 0x86, 0xA0, 0x08, 0x2D, 0xC6, 0xC0, 0x00, 0x06, 0xD4
...
#define FREQ_CONTROL_INTE_12 0x11, 0x40, 0x08, 0x00,  0x38, 0x0D, 0xDD, 0xDD, 0x00, 0x00, 0x20,  0xFE


// all for RX below:
// MDM_CTRL: 1 byte,  IF_CONTROL: 1B,  IF_FREQ: 3B,  DECIMATION_CFG: 2B,  for all RX 
#define MODEM_MDM_CTRL_11 0x11, 0x20, 0x07, 0x19,   0x00, 0x08, 0x03, 0x80, 0x00, 0x20, 0x20
...
#define MODEM_AFC_GEAR_12 0x11, 0x20, 0x08, 0x2C,  0x00, 0x12, 0x81, 0xB5, 0x01, 0xCB, 0xA0, 0x00
...
// raw: 4 bytes, for RX 
#define MODEM_RAW_SEARCH_8 0x11, 0x20, 0x04, 0x44,  0xD6, 0x03, 0x01, 0xAA
