...
//按键输入脚的位地址
    ...
    static inline u32 KeyI(u8 KeyRow) {
        switch (KeyRow) {
        case 0:
            return GPB_I(4); // PB4  KEY_DIV/key_right
        case 1:
            return GPB_I(5); // PB5  KEY_ENTER
        case 2:
            return GPB_I(7); // PB7  KEY_MULT/KEY_LEFT  
        case 3:
            return GPB_I(6); // PB6  KEY_DOWN
        case 4:
            return GPB_I(3); // PB3  KEY_UP
        case 5:
            return GPB_I(0); // PB0  KEY_POWER
        case 6:
            return GPB_I(11); // PB11  KEY_HALF_ENTER
        }
        return 0;
    };
