...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA0     ------> ADC1_IN1
    */
    GPIO_InitStruct.Pin = SNSR_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(SNSR_ADC_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if (hadc->Instance == ADC1)
  {
    ...
    PA0     ------> ADC1_IN1
    */
    HAL_GPIO_DeInit(SNSR_ADC_GPIO_Port, SNSR_ADC_Pin);
...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  if (hdac->Instance == DAC1)
  {
    ...
    PA5     ------> DAC1_OUT2
    */
    GPIO_InitStruct.Pin = SNSR_DAC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(SNSR_DAC_GPIO_Port, &GPIO_InitStruct);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  if (hdac->Instance == DAC1)
  {
    ...
    PA5     ------> DAC1_OUT2
    */
    HAL_GPIO_DeInit(SNSR_DAC_GPIO_Port, SNSR_DAC_Pin);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  else if (htim_base->Instance == TIM3)
  {
    ...
    */
    ...
    // 配置TIM3_CH4为输入捕获模式
    // 注意：PB1引脚已经配置为TIM3_CH4的复用功能，无需额外配置
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  else if (htim->Instance == TIM15)
  {
    ...
    PA3     ------> TIM15_CH2
    */
    GPIO_InitStruct.Pin = SNSR_CONTROL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF9_TIM15;
    HAL_GPIO_Init(SNSR_CONTROL_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  else if (htim_base->Instance == TIM3)
  {
    ...
    PB1     ------> TIM3_CH4
    */
    HAL_GPIO_DeInit(DRIVER_STROBE_GPIO_Port, DRIVER_STROBE_Pin);

    HAL_GPIO_DeInit(CHG_STS_GPIO_Port, CHG_STS_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  if (htim_encoder->Instance == TIM4)
  {
    ...
    PA12     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOA, KEY_CHA_Pin | KEY_CHB_Pin);
